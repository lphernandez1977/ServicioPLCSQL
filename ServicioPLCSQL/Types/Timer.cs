...
namespace ServicioPLCSQL.Types 
{
    public static class Timer
    {
        ...
        public static double FromByteArray(byte[] bytes)
        {
            ...
            string txt = cEntidades.cConversion.ValToBinString(value);
            wert = cEntidades.cConversion.BinStringToInt(txt.Substring(4, 4)) * 100.0;
            wert += cEntidades.cConversion.BinStringToInt(txt.Substring(8, 4)) * 10.0;
            wert += cEntidades.cConversion.BinStringToInt(txt.Substring(12, 4));
